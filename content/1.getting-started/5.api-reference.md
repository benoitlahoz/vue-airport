...
| `onCheckOut` | `(id) => void` or `(id, data) => void` | Hook called after successful check-out. Supports both signatures: legacy `(id, desk)` and new `(id, data, desk)` with item data | `undefined` |
...
interface CheckInPlugin<T = any> {
   ...
   */
  onCheckOut?: {
    (id: string | number, desk: DeskCore<T>): void;
    (id: string | number, data: T, desk: DeskCore<T>): void;
  };
