...
VueAirport provides a powerful plugin system that allows you to extend the functionality of check-in desks with reusable features.
...
- Learn about the [Validation Plugin](/plugins/base/validation) for data integrity
...
- See the [Multi-Plugin Example](/examples/plugin) for a complete working implementation
