...
seo:
  title: History Plugin
  description: Learn how to use the History Plugin to track and audit operations in VueCheckIn.
---
...
See the examples section for complete working implementations using the History Plugin.
