---
title: Todo List
description: A simple todo list example showcasing VueCheckIn features.
navigation:
  icon: i-heroicons-list-bullet
seo:
  title: Todo List
  description: Explore a straightforward todo list example that showcases the fundamental features of VueCheckIn.
---

A simple todo list demonstrating the core features of vue-checkin:
