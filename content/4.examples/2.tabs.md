...
seo:
  title: Tabs Example - VueCheckIn
  description: Learn how to implement dynamic tabs with shared context, active state management, and automatic component registration using VueCheckIn.
---
