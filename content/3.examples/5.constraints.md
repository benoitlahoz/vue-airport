...
- Maximum member count (5)
- Name pattern (min 3 letters, A-Z)
- ID range (1–99999)
- Forbidden names ("Admin", "Root")
- Only one guest allowed
- Async constraint (forbidden name "forbiddenasync")
...
10. **Clear errors** button resets all errors
